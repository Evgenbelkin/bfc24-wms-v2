 ...
 */
async function createAct({ tenantId, warehouseId, clientId, userId, inboundOrderId = null, act = {}, lines = [] }) {
...
async function listActs({ tenantId, clientId = null, inboundOrderId = null, dateFrom = null, dateTo = null, limit = 100, offset = 0 }) {
...
module.exports = { createAct, getAct, updateAct, listActs, getFreeReceivingLinesForAct };
